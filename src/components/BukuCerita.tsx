...
const halaman = [
  ...
  },
  {
    ...
    bg: '#f5f0ff',
    emoji: '🌐',
    isi: 'Gelar.id — Kampus Virtual Teknologi. Ekosistem digital pertama yang memadukan pendidikan, komunitas kreator, dan platform ekonomi kreatif dalam satu platform.',
    panels: [
