...
const experiences = [
  { year: '2026', title: 'Penelitian Skripsi', desc: 'Menjalankan penelitian skripsi bidang Teknologi Informasi sambil mengembangkan platform Gelar.id.' },
  ...
  return (
    <section id="cv" className="py-20 px-4 relative" style={{ background: '#fafaf7' }}>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* Header */}
        <HeaderBab nomor="CV" judul="MY PROFILE" warna="#1a5cff" subtitle="📄 Unduh CV lengkap saya di sini!" />
