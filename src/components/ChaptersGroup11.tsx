...
function Ch111() {
  return (
    <CP id="ch111" chNum="CHAPTER 111" title="WARISAN DIGITAL — APA YANG KUTINGGALKAN" color="#8b5cf6" bg="#f5f0ff">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        <div className="space-y-4">
          {[
            ...
            { warisan: 'Website Desa Digital', dampak: 'Puluhan desa yang kini punya kehadiran digital dan bisa bersaing di era modern', icon: '🏘️', warna: '#22c55e' },
            ...
            { warisan: 'Inovasi IoT Daur Ulang', dampak: 'Membuktikan bahwa inovasi tidak butuh modal besar — kreativitas adalah modal utama', icon: '♻️', warna: '#e63329' },
          ].map((w, i) => (
...
function Ch112() {
  return (
    <CP id="ch112" chNum="CHAPTER 112" title="SOSIAL & DAMPAK NYATA TEKNOLOGI" color="#22c55e" bg="#f0fdf4">
      ...
      <Grid3 items={[
        { icon: '🏘️', judul: 'Digitalisasi Desa', teks: '75.000+ desa Indonesia belum punya website layak. Satu developer bisa bantu 100 desa!', warna: '#22c55e', bg: '#f0fdf4' },
        ...
        { icon: '♻️', judul: 'Lingkungan Hidup', teks: 'IoT monitoring lingkungan, smart farming, dan optimasi energi untuk masa depan yang lebih hijau', warna: '#0891b2', bg: '#ecfeff' },
...
function Ch113() {
  const nilai = [
    ...
    { nilai: 'TANGGUNG JAWAB', desc: 'Kode yang ditulis adalah tanggung jawab yang diambil. Tidak ada "bukan urusan saya" untuk bug di kode yang kamu tulis', icon: '⚖️', warna: '#22c55e' },
  ...
  return (
    <CP id="ch113" chNum="CHAPTER 113" title="NILAI & PRINSIP HIDUP DEVELOPER" color="#1a5cff" bg="#e8f0ff">
      <div className="speech-bubble inline-block text-sm mb-6">
        ⚖️ Skill bisa dipelajari, tapi karakter adalah yang membedakan developer biasa dari developer yang luar biasa!
      </div>
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {nilai.map((n, i) => (
...
function Ch114() {
  ...
  return (
    <CP id="ch114" chNum="CHAPTER 114" title="SURAT — PESAN UNTUK MEREKA" color="#8b5cf6" bg="#f5f0ff">
      <div className="speech-bubble-right inline-block text-sm mb-6 text-[#0a0a0a]">
        ✉️ Ada beberapa hal yang perlu disampaikan — kepada mereka yang ada dalam perjalanan ini
      </div>
      <div className="space-y-4">
        {pesan.map((p, i) => (
...
function Ch115() {
  return (
    <CP id="ch115" chNum="CHAPTER 115" title="MIMPI YANG BELUM TERWUJUD — BUCKET LIST" color="#f59e0b" bg="#fffbeb">
      <div className="speech-bubble inline-block text-sm mb-6">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        {[
          ...
          { mimpi: 'Kunjungi Silicon Valley & Tokyo', status: 'DREAM', icon: '✈️', warna: '#8b5cf6', tipe: 'PERJALANAN' },
...
function Ch116() {
  return (
    <CP id="ch116" chNum="CHAPTER 116" title="REFLEKSI — CERMIN PERJALANAN INI" color="#0891b2" bg="#ecfeff">
      <div className="speech-bubble-right inline-block text-sm mb-6 text-[#0a0a0a]">
...
function Ch117() {
  return (
    <CP id="ch117" chNum="CHAPTER 117" title="INDONESIA DIGITAL — PERAN KITA" color="#e63329" bg="#fef2f2">
      <div className="speech-bubble inline-block text-sm mb-6">
...
function Ch118() {
  ...
  return (
    <CP id="ch118" chNum="CHAPTER 118" title="ROADMAP 2026-2030 — PETA JALAN BESAR" color="#1a5cff" bg="#e8f0ff">
      <div className="speech-bubble-right inline-block text-sm mb-6 text-[#0a0a0a]">
        🗺️ Tanpa peta, semua jalan terasa sama. Ini peta perjalanan saya — dan saya siap jalan!
      </div>
...
function Ch119() {
  return (
    <CP id="ch119" chNum="CHAPTER 119" title="EPILOG AGUNG — SEBELUM CHAPTER TERAKHIR" color="#ffd700" bg="#fffbeb" dark>
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="grid sm:grid-cols-2 gap-4 mb-8">
          {[
            ...
            { label: 'Cerita yang Dibagikan', val: '∞ tak terhitung', icon: '❤️', warna: '#e63329' },
...
function Ch120() {
  return (
    <CP id="ch120" chNum="CHAPTER 120" title="BERSAMBUNG... — THE END IS THE BEGINNING" color="#ffd700" bg="#fffbeb" dark>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-8">
          {[
            ...
            { angka: '∞', label: 'Semangat Tersisa', icon: '🔥', warna: '#e63329' },
