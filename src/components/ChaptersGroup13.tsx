...
function Ch131() {
  ...
  return (
    <CP id="ch131" num="131" title="WIRAUSAHA SOSIAL — BISNIS YANG BERDAMPAK" color="#22c55e" bg="#f0fdf4">
...
function Ch132() {
  return (
    <CP id="ch132" num="132" title="KOLABORASI GLOBAL — DUNIA TANPA BATAS" color="#0891b2" bg="#ecfeff">
      ...
      <G3 items={[
        ...
        { icon: '🗣️', judul: 'English is Key', teks: 'Bahasa Inggris bukan halangan — ini investasi. Mulai dari GitHub commit message yang baik!', warna: '#0891b2', bg: '#ecfeff' },
      ]} />
    </CP>
  )
}
...
function Ch133() {
  return (
    <CP id="ch133" num="133" title="TEKNOLOGI & LINGKUNGAN — KODE UNTUK BUMI" color="#22c55e" bg="#f0fdf4">
...
function Ch134() {
  return (
    <CP id="ch134" num="134" title="HEALTHTECH — INOVASI KESEHATAN DIGITAL" color="#e63329" bg="#fef2f2">
      <div className="speech-bubble-right inline-block text-sm mb-6 text-[#0a0a0a]">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="comic-panel-dark p-5">
          <div className="font-comic text-xl text-white mb-3">🇮🇩 HEALTHTECH INDONESIA</div>
...
function Ch135() {
  return (
    <CP id="ch135" num="135" title="AGRITECH — REVOLUSI PERTANIAN DIGITAL" color="#22c55e" bg="#f0fdf4">
      ...
      <G3 items={[
        ...
        { icon: '🌦️', judul: 'Micro Weather', teks: 'Stasiun cuaca IoT murah per desa yang berikan prakiraan hyper-lokal untuk keputusan pertanian', warna: '#0891b2', bg: '#ecfeff' },
...
function Ch136() {
  return (
    <CP id="ch136" num="136" title="EDTECH INOVATIF — MASA DEPAN BELAJAR" color="#8b5cf6" bg="#f5f0ff">
      <div className="speech-bubble-right inline-block text-sm mb-6 text-[#0a0a0a]">
...
function Ch137() {
  return (
    <CP id="ch137" num="137" title="EKONOMI KREATIF — KARYA DIGITAL BERNILAI" color="#f59e0b" bg="#fffbeb">
      ...
      <div className="grid sm:grid-cols-2 gap-4 mb-6">
        {[
          { kategori: 'Digital Art & NFT', deskripsi: 'Karya digital yang kepemilikannya terverifikasi blockchain. Seniman bisa jual langsung ke kolektor global', icon: '🎨', tools: ['Procreate', 'Photoshop', 'OpenSea'], warna: '#8b5cf6' },
          ...
          { kategori: 'Game Development', deskripsi: 'Indie game developer bisa rilis global via Steam, App Store, Play Store. Satu game sukses = financial freedom', icon: '🎮', tools: ['Unity', 'Godot', 'Unreal Engine'], warna: '#1a5cff' },
          { kategori: 'UI/UX Freelance', deskripsi: 'Designer yang bisa koding = unicorn yang dicari startup. Rate premium untuk hybrid skill ini', icon: '✏️', tools: ['Figma', 'Framer', 'Webflow'], warna: '#22c55e' },
        ].map((k, i) => (
...
function Ch138() {
  return (
    <CP id="ch138" num="138" title="SMART CITY — KOTA YANG CERDAS" color="#1a5cff" bg="#e8f0ff">
      <div className="speech-bubble-right inline-block text-sm mb-6 text-[#0a0a0a]">
      ...
      <G3 items={[
        ...
        { icon: '📊', judul: 'City Dashboard', teks: 'Command center walikota dengan semua data kota real-time — dari kriminalitas sampai kualitas udara', warna: '#1a5cff', bg: '#e8f0ff' },
      ]} />
      <div className="mt-6 comic-panel-yellow p-4 text-center">
        <div className="font-comic text-base text-[#0a0a0a] mb-2">🎯 SMART CITY JEMBER 2030?</div>
...
function Ch139() {
  return (
    <CP id="ch139" num="139" title="SUPPLY CHAIN TECH — RANTAI PASOK DIGITAL" color="#f59e0b" bg="#fffbeb">
      ...
      <G3 items={[
        ...
        { icon: '🔗', judul: 'Blockchain Provenance', teks: 'Verifikasi keaslian produk dari sumber sampai konsumen. Sangat penting untuk produk premium dan obat-obatan', warna: '#1a5cff', bg: '#e8f0ff' },
...
function Ch140() {
  return (
    <CP id="ch140" num="140" title="MENTAL HEALTH TECH — KESEHATAN JIWA DIGITAL" color="#8b5cf6" bg="#f5f0ff">
      <div className="speech-bubble-right inline-block text-sm mb-6 text-[#0a0a0a]">
      ...
      <div className="mt-6 comic-panel-dark p-4 text-center">
        <div className="font-comic text-lg text-white mb-2">💜 PESAN PENTING</div>
