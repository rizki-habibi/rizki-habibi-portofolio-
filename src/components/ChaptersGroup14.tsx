...
function Ch141() {
  const karya = [
    ...
    { jenis: 'Interactive Installation', desc: 'Seni yang merespons gerakan pengunjung menggunakan sensor, kamera, dan proyektor interaktif', tech: 'openFrameworks, Arduino, Max/MSP', icon: '🖥️', warna: '#22c55e' },
  ]
  return (
    <CP id="ch141" num="141" title="SENI DIGITAL — KREATIVITAS TANPA BATAS" color="#8b5cf6" bg="#f5f0ff">
...
function Ch142() {
  return (
    <CP id="ch142" num="142" title="MUSIK & TEKNOLOGI — HARMONI DIGITAL" color="#1a5cff" bg="#e8f0ff">
      ...
      <G3 items={[
        ...
        { icon: '🎤', judul: 'Voice Cloning', teks: 'Eleven Labs dan ElevenVoices — replikasi suara dengan AI. Disruptif untuk dubbing dan aksesibilitas', warna: '#f59e0b', bg: '#fffbeb' },
...
function Ch143() {
  ...
  return (
    <CP id="ch143" num="143" title="CONTENT CREATOR TECH — SENJATA KREATOR" color="#e63329" bg="#fef2f2">
...
function Ch144() {
  return (
    <CP id="ch144" num="144" title="SOSIAL MEDIA — MEMAHAMI ALGORITMANYA" color="#0a66c2" bg="#e8f2ff">
      <div className="speech-bubble-right inline-block text-sm mb-6 text-[#0a0a0a]">
      ...
      <G3 items={[
        ...
        { icon: '▶️', judul: 'YouTube Algorithm', teks: 'Click-through rate + Watch time adalah raja. Thumbnail dan judul menarik, konten berkualitas adalah wajib', warna: '#e63329', bg: '#fef2f2' },
...
function Ch145() {
  return (
    <CP id="ch145" num="145" title="PODCAST & AUDIO — KONTEN YANG DIDENGAR" color="#f59e0b" bg="#fffbeb">
...
function Ch146() {
  return (
    <CP id="ch146" num="146" title="FASHION TECH — INDUSTRI YANG BERTRANSFORMASI" color="#e1306c" bg="#fff0f5">
      <div className="speech-bubble-right inline-block text-sm mb-6 text-[#0a0a0a]">
      ...
      <G3 items={[
        ...
        { icon: '🏭', judul: 'Supply Chain Fashion', teks: 'Blockchain untuk transparansi dari bahan baku ke tangan konsumen — counter greenwashing brand besar', warna: '#1a5cff', bg: '#e8f0ff' },
...
function Ch147() {
  return (
    <CP id="ch147" num="147" title="SPORT TECH — TEKNOLOGI DI DUNIA OLAHRAGA" color="#22c55e" bg="#f0fdf4">
      ...
      <G3 items={[
        ...
        { icon: '🎯', judul: 'Referee AI', teks: 'VAR di sepak bola adalah awal. AI hakim bulu tangkis, tinju, dan senam sudah dalam pengembangan', warna: '#f59e0b', bg: '#fffbeb' },
        { icon: '🏋️', judul: 'Personal Trainer AI', teks: 'Camera pose estimation + AI memberikan real-time feedback form latihan — personal trainer digital gratis', warna: '#e63329', bg: '#fef2f2' },
...
function Ch148() {
  return (
    <CP id="ch148" num="148" title="KULINER TECH — INOVASI DI INDUSTRI MAKANAN" color="#f59e0b" bg="#fffbeb">
      <div className="speech-bubble-right inline-block text-sm mb-6 text-[#0a0a0a]">
...
function Ch149() {
  return (
    <CP id="ch149" num="149" title="TRANSPORTASI — MOBILITAS MASA DEPAN" color="#0891b2" bg="#ecfeff">
...
function Ch150() {
  return (
    <CP id="ch150" num="150" title="MASA DEPAN PEKERJAAN — PEKERJAAN 2030" color="#ffd700" bg="#fffbeb" dark>
