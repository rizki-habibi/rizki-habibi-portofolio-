...
function Ch161() {
  ...
  return (
    <CP id="ch161" num="161" title="100 HARI PRODUKTIF — CHALLENGE HIDUP" color="#1a5cff" bg="#e8f0ff">
...
function Ch162() {
  ...
  return (
    <CP id="ch162" num="162" title="PROYEK IMPIAN 2027 — VISI YANG MENANTI" color="#8b5cf6" bg="#f5f0ff">
...
function Ch163() {
  return (
    <CP id="ch163" num="163" title="SATU TAHUN KVT.KOM — PROYEKSI & HARAPAN" color="#22c55e" bg="#f0fdf4">
...
function Ch164() {
  ...
  return (
    <CP id="ch164" num="164" title="PESAN UNTUK GENERASI BERIKUTNYA" color="#ffd700" bg="#fffbeb" dark>
...
function Ch165() {
  return (
    <CP id="ch165" num="165" title="SYUKUR — BERSYUKUR ATAS SETIAP PERJALANAN" color="#f59e0b" bg="#fffbeb">
      <div className="speech-bubble-right inline-block text-sm mb-6 text-[#0a0a0a]">
...
function Ch166() {
  ...
  return (
    <CP id="ch166" num="166" title="8 PELAJARAN TERBESAR HIDUP" color="#e63329" bg="#fef2f2">
...
function Ch167() {
  return (
    <CP id="ch167" num="167" title="SALAM DARI JEMBER — KOTA YANG MEMBESARKAN" color="#22c55e" bg="#f0fdf4">
      <div className="speech-bubble-right inline-block text-sm mb-6 text-[#0a0a0a]">
        🏙️ Jember bukan kota besar, tapi melahirkan mimpi-mimpi yang tidak kalah besar!
      </div>
      <div className="grid lg:grid-cols-2 gap-8">
        <div className="space-y-4">
...
function Ch168() {
  ...
  return (
    <CP id="ch168" num="168" title="KATA-KATA PAMUNGKAS — SEBELUM EPILOG" color="#ffd700" bg="#fffbeb" dark>
      <div className="speech-bubble inline-block text-sm mb-6 text-[#0a0a0a]">
...
function Ch169() {
  return (
    <CP id="ch169" num="169" title="APRESIASI — TERIMA KASIH YANG TULUS" color="#f59e0b" bg="#fffbeb">
      <div className="speech-bubble-right inline-block text-sm mb-6 text-[#0a0a0a]">
...
function Ch170() {
  return (
    <CP id="ch170" num="170" title="THE GRAND FINALE — SAMPAI BERJUMPA LAGI!" color="#ffd700" bg="#fffbeb" dark>
      <div className="max-w-3xl mx-auto text-center">
        ...
        <div className="grid sm:grid-cols-3 gap-4 mb-8">
          {[
            ...
            { angka: '∞', label: 'Kisah Tersisa', icon: '✨', warna: '#e63329' },
