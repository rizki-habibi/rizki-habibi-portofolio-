    ...
    <section id={id} className="py-20 px-4 relative overflow-hidden" style={{ background: bgColor }}>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }} viewport={{ once: false, amount: 0.2 }}
...
function Ch26() {
  return (
    <ComicPanel id="ch26" chNum="CHAPTER 26" title="AI JOURNEY — PERJALANAN DENGAN AI" color="#8b5cf6" bgColor="#f5f0ff">
...
function Ch27() {
  ...
  return (
    <ComicPanel id="ch27" chNum="CHAPTER 27" title="TECH STACK DEEP DIVE" color="#1a5cff" bgColor="#e8f0ff">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch28() {
  return (
    <ComicPanel id="ch28" chNum="CHAPTER 28" title="OPEN SOURCE & KONTRIBUSI" color="#22c55e" bgColor="#f0fdf4">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch29() {
  return (
    <ComicPanel id="ch29" chNum="CHAPTER 29" title="KEAMANAN SIBER — ETIKA HACKER" color="#e63329" bgColor="#fef2f2">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch30() {
  return (
    <ComicPanel id="ch30" chNum="CHAPTER 30" title="CLOUD COMPUTING & DEVOPS" color="#0078d4" bgColor="#e8f2ff">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch31() {
  return (
    <ComicPanel id="ch31" chNum="CHAPTER 31" title="DATABASE & DATA ENGINEERING" color="#4479a1" bgColor="#eff6ff">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch32() {
  return (
    <ComicPanel id="ch32" chNum="CHAPTER 32" title="UI/UX DESIGN THINKING" color="#ec4899" bgColor="#fdf2f8">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch33() {
  ...
  return (
    <ComicPanel id="ch33" chNum="CHAPTER 33" title="MENDALAMI ARTIFICIAL INTELLIGENCE" color="#8b5cf6" bgColor="#f5f0ff">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch34() {
  return (
    <ComicPanel id="ch34" chNum="CHAPTER 34" title="INTERNET OF THINGS — DUNIA FISIK DIGITAL" color="#00979D" bgColor="#f0fffe">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch35() {
  return (
    <ComicPanel id="ch35" chNum="CHAPTER 35" title="DIGITAL MARKETING & BRANDING" color="#ec4899" bgColor="#fdf2f8">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
