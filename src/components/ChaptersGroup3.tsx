...
function Grid({ items }: { items: { icon: string; title: string; text: string; color: string; bg: string }[] }) {
  return (
...
function Ch36() {
  return (
    <CP id="ch36" chNum="CHAPTER 36" title="KESEHATAN DIGITAL" color="#22c55e" bg="#f0fdf4">
...
function Ch37() {
  return (
    <CP id="ch37" chNum="CHAPTER 37" title="TEKNOLOGI UNTUK LINGKUNGAN" color="#16a34a" bg="#f0fdf4">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch38() {
  return (
    <CP id="ch38" chNum="CHAPTER 38" title="DAMPAK SOSIAL TEKNOLOGI" color="#1a5cff" bg="#e8f0ff">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch39() {
  return (
    <CP id="ch39" chNum="CHAPTER 39" title="PERSONAL GROWTH — BERTUMBUH SETIAP HARI" color="#f59e0b" bg="#fffbeb">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch40() {
  return (
    <CP id="ch40" chNum="CHAPTER 40" title="LEADERSHIP & TEAM MANAGEMENT" color="#e63329" bg="#fef2f2">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch41() {
  return (
    <CP id="ch41" chNum="CHAPTER 41" title="PROBLEM SOLVING MINDSET" color="#8b5cf6" bg="#f5f0ff">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch42() {
  return (
    <CP id="ch42" chNum="CHAPTER 42" title="SOFT SKILLS — KEKUATAN TERSEMBUNYI" color="#0891b2" bg="#ecfeff">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch43() {
  return (
    <CP id="ch43" chNum="CHAPTER 43" title="LOGIKA & COMPUTATIONAL THINKING" color="#f59e0b" bg="#fffbeb">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch44() {
  return (
    <CP id="ch44" chNum="CHAPTER 44" title="KREATIVITAS TANPA BATAS" color="#ec4899" bg="#fdf2f8">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch45() {
  return (
    <CP id="ch45" chNum="CHAPTER 45" title="DREAM BIG — VISI JANGKA PANJANG" color="#8b5cf6" bg="#f5f0ff">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
