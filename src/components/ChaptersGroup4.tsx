...
function CP({ id, chNum, title, color, bg, dark, children }: {
  ...
  return (
    <section id={id} className="py-20 px-4 relative overflow-hidden" style={{ background: dark ? '#0a0a0a' : bg }}>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: false, amount: 0.2 }} className="text-center mb-12">
          <div className="chapter-label mb-3 inline-block" style={{ color: dark ? '#ffd700' : color, borderColor: dark ? '#ffd700' : color }}>{chNum}</div>
          <h2 className={dark ? 'section-title-white' : 'section-title'}>{title}</h2>
        </motion.div>
        {children}
      </div>
    </section>
...
function Ch46() {
  ...
  return (
    <CP id="ch46" chNum="CHAPTER 46" title="MOTIVASI HARIAN" color="#f59e0b" bg="#fffbeb">
...
function Ch47() {
  return (
    <CP id="ch47" chNum="CHAPTER 47" title="BELAJAR DARI KEGAGALAN" color="#e63329" bg="#fef2f2">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch48() {
  return (
    <CP id="ch48" chNum="CHAPTER 48" title="KOLABORASI GLOBAL" color="#0891b2" bg="#ecfeff">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch49() {
  return (
    <CP id="ch49" chNum="CHAPTER 49" title="MASA DEPAN TEKNOLOGI" color="#8b5cf6" bg="#f5f0ff">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch50() {
  return (
    <CP id="ch50" chNum="CHAPTER 50 — MILESTONE" title="SETENGAH JALAN — REFLEKSI" color="#ffd700" bg="#fffbeb" dark>
...
function Ch51() {
  return (
    <CP id="ch51" chNum="CHAPTER 51" title="RASA SYUKUR — GRATITUDE" color="#22c55e" bg="#f0fdf4">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch52() {
  return (
    <CP id="ch52" chNum="CHAPTER 52" title="UMKM GOES DIGITAL" color="#f59e0b" bg="#fffbeb">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch53() {
  return (
    <CP id="ch53" chNum="CHAPTER 53" title="SMART CITY — KOTA CERDAS" color="#0891b2" bg="#ecfeff">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch54() {
  return (
    <CP id="ch54" chNum="CHAPTER 54" title="KELUARGA — FONDASI SEGALANYA" color="#e63329" bg="#fef2f2">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
...
function Ch55() {
  return (
    <CP id="ch55" chNum="CHAPTER 55" title="IDENTITAS — SIAPA RIZKI HABIBI?" color="#8b5cf6" bg="#f5f0ff">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
