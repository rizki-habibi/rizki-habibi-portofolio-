    ...
    <section id={id} className="py-20 px-4 relative overflow-hidden" style={{ background: dark ? '#0a0a0a' : bg }}>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }} viewport={{ once: false, amount: 0.2 }} className="text-center mb-12">
          <div className="chapter-label mb-3 inline-block" style={{ color: dark ? '#ffd700' : color, borderColor: dark ? '#ffd700' : color }}>
            {chNum}
          </div>
...
function Ch56() {
  ...
  return (
    <CP id="ch56" chNum="CHAPTER 56" title="WARISAN DIGITAL UNTUK GENERASI MENDATANG" color="#8b5cf6" bg="#f5f0ff">
...
function Ch57() {
  ...
  return (
    <CP id="ch57" chNum="CHAPTER 57" title="INOVASI TANPA HENTI — THE NEXT BIG THINGS" color="#1a5cff" bg="#e8f0ff">
...
function Ch58() {
  return (
    <CP id="ch58" chNum="CHAPTER 58" title="SEMUA KARAKTER BERKUMPUL" color="#f59e0b" bg="#fffbeb">
      <div className="grid md:grid-cols-2 gap-8 mb-10">
        <div>
          <div className="speech-bubble inline-block text-sm mb-6">
...
function Ch59() {
  return (
    <CP id="ch59" chNum="CHAPTER 59" title="PESAN UNTUK DEVELOPER MUDA INDONESIA" color="#22c55e" bg="#f0fdf4">
      <div className="grid md:grid-cols-2 gap-8 mb-10">
        <div>
          <div className="speech-bubble inline-block text-sm mb-6">
...
function Ch60() {
  return (
    <CP id="ch60" chNum="CHAPTER 60" title="INDONESIA DIGITAL FUTURE" color="#e63329" bg="#fef2f2" dark>
      <div className="grid md:grid-cols-2 gap-8 mb-10">
        <div>
...
function Ch61() {
  return (
    <CP id="ch61" chNum="CHAPTER 61 — THE PENULTIMATE CHAPTER" title="SATU LANGKAH SEBELUM FINAL" color="#ffd700" bg="#fffbeb" dark>
