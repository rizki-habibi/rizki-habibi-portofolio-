...
function Ch62() {
  ...
  return (
    <CP id="ch62" chNum="CHAPTER 62" title="GAME LIFE: POKEMON GO!" color="#22c55e" bg="#f0fdf4">
...
function Ch63() {
  ...
  return (
    <CP id="ch63" chNum="CHAPTER 63" title="DUEL MONSTERS: YUGIOH!" color="#ffd700" bg="#fffbeb" dark>
...
function Ch64() {
  ...
  return (
    <CP id="ch64" chNum="CHAPTER 64" title="MASTER STRATEGI & TAKTIK" color="#e63329" bg="#fef2f2">
...
function Ch65() {
  ...
  return (
    <CP id="ch65" chNum="CHAPTER 65" title="KINGDOM BUILDER — RAJA VIRTUAL" color="#f59e0b" bg="#fffbeb">
      <div className="grid lg:grid-cols-2 gap-8">
        <SlideKomik slides={slides} />
        <div className="space-y-4">
...
function Ch66() {
  ...
  return (
    <CP id="ch66" chNum="CHAPTER 66" title="DRAGON QUEST & PETUALANGAN EPIK" color="#e63329" bg="#fef2f2">
      <div className="speech-bubble inline-block text-sm mb-6">
...
function Ch67() {
  ...
  return (
    <CP id="ch67" chNum="CHAPTER 67" title="MINECRAFT: DUNIA TANPA BATAS" color="#22c55e" bg="#f0fdf4">
      <div className="grid lg:grid-cols-2 gap-8">
        <div>
          <div className="speech-bubble inline-block text-sm mb-4">
...
function Ch68() {
  ...
  return (
    <CP id="ch68" chNum="CHAPTER 68" title="OFFLINE ADVENTURES — DUNIA TANPA INTERNET" color="#8b5cf6" bg="#f5f0ff">
      <div className="grid lg:grid-cols-2 gap-8">
        <div>
          <div className="speech-bubble inline-block text-sm mb-4">
...
function Ch69() {
  ...
  return (
    <CP id="ch69" chNum="CHAPTER 69" title="GAME = SEKOLAH CODING PERTAMAKU" color="#1a5cff" bg="#e8f0ff">
...
function Ch70() {
  ...
  return (
    <CP id="ch70" chNum="CHAPTER 70" title="WISHLIST & IMPIAN GAMER" color="#f59e0b" bg="#fffbeb">
      <div className="speech-bubble inline-block text-sm mb-6">
