  ...
  return (
    <section id="epilog" className="py-20 px-4 relative overflow-hidden" style={{ background: '#fafaf7' }}>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <div className="font-comic text-2xl text-white text-center mb-8">📅 ROADMAP 2026–FUTURE</div>
        ...
        >
          ...
          <div className="md:col-span-2">
            ...
            >
              ...
              <p className="font-bold text-lg text-comic-black leading-relaxed mb-4 relative z-10">
