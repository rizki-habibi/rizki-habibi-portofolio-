  ...
  return (
    <PanelBab id="ch133" num="133" judul="TEKNOLOGI & LINGKUNGAN — KODE UNTUK BUMI" warna="#22c55e" latarBelakang="#f0fdf4">
      ...
      <GridTiga items={[
        ...
        { icon: '??', judul: 'Circular Economy', teks: 'Platform digital untuk waste exchange — sisa produksi satu perusahaan jadi bahan baku perusahaan lain', warna: '#f59e0b', bg: '#fffbeb' },
        { icon: '???', judul: 'Climate Modeling', teks: 'Supercomputer + ML untuk model iklim yang akurasi lebih tinggi dan prediksi lebih jauh ke depan', warna: '#e63329', bg: '#fef2f2' },
...
function Ch138() {
  return (
    <PanelBab id="ch138" num="138" judul="SMART CITY — KOTA YANG CERDAS" warna="#1a5cff" latarBelakang="#e8f0ff">
      <div className="speech-bubble-right inline-block text-sm mb-6 text-[#0a0a0a]">
        ??? Kota cerdas bukan tentang gadget — ini tentang data dan keputusan yang lebih baik untuk warga!
      </div>
      <GridTiga items={[
        ...
        { icon: '???', judul: 'Smart Waste', teks: 'Sensor di tong sampah yang alert saat penuh — truk sampah hanya datang jika diperlukan, hemat BBM', warna: '#22c55e', bg: '#f0fdf4' },
        ...
        { icon: '???', judul: 'Smart Parking', teks: 'Sensor parkir + app — lihat slot kosong sebelum masuk. Kurangi 30% kemacetan yang disebabkan cari parkir', warna: '#8b5cf6', bg: '#f5f0ff' },
