...
function Ch141() {
  const karya = [
    ...
    { jenis: 'Pixel Art', desc: 'Seni piksel yang lahir dari keterbatasan hardware lawas — kini jadi estetika nostalgia yang sangat populer', tech: 'Aseprite, Pixaki, GraphicsGale', icon: '???', warna: '#1a5cff' },
...
function Ch143() {
  const stack = [
    ...
    { alat: 'Descript', fungsi: 'Edit video dengan mengedit teks transkrip — revolusi editing podcast dan video interview', icon: '??', warna: '#8b5cf6' },
...
function Ch145() {
  return (
    <PanelBab id="ch145" num="145" judul="PODCAST & AUDIO — KONTEN YANG DIDENGAR" warna="#f59e0b" latarBelakang="#fffbeb">
      <div className="speech-bubble inline-block text-sm mb-6">??? Podcast tech Indonesia sedang booming — dan developer punya perspektif unik yang dibutuhkan pendengar!</div>
      <div className="grid lg:grid-cols-2 gap-8">
        <div className="space-y-3">
          <div className="comic-panel p-4">
            <div className="font-comic text-base text-[#0a0a0a] mb-3">??? SETUP PODCAST MINIMAL</div>
            {[
  ...
  return (
    <PanelBab id="ch146" num="146" judul="FASHION TECH — INDUSTRI YANG BERTRANSFORMASI" warna="#e1306c" latarBelakang="#fff0f5">
      ...
      <GridTiga items={[
        ...
        { icon: '??', judul: 'Sustainable Fashion', teks: 'Platform resale fashion (Carousell, ThriftedID) yang diperkuat AI untuk valuation dan authenticity check', warna: '#22c55e', bg: '#f0fdf4' },
  ...
  return (
    <PanelBab id="ch149" num="149" judul="TRANSPORTASI — MOBILITAS MASA DEPAN" warna="#0891b2" latarBelakang="#ecfeff">
      ...
      <GridTiga items={[
        ...
        { icon: '??', judul: 'Aviation Analytics', teks: 'Predictive maintenance pesawat berbasis sensor dan ML — cegah kerusakan sebelum terjadi mid-flight', warna: '#e63329', bg: '#fef2f2' },
      ]} />
    </PanelBab>
  )
}
