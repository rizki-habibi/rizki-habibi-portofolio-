...
function Ch153() {
  const filsafat = [
    ...
    { filsuf: 'Kaizen (??)', relevan: 'Filosofi Jepang: perbaikan kecil setiap hari lebih powerful dari perubahan besar sesekali. 1% sehari!', icon: '??', warna: '#22c55e' },
    ...
    { filsuf: 'Wabi-Sabi (??)', relevan: 'Keindahan dalam ketidaksempurnaan. Shipped imperfect > never shipped perfect. MVP adalah seni!', icon: '??', warna: '#f59e0b' },
        ...
        <div className="comic-panel-dark p-5">
          ...
          <div className="space-y-2">
            {[
              ...
              'Hindari gelap patterns yang manipulasi pengguna',
...
function Ch156() {
  return (
    <PanelBab id="ch156" num="156" judul="INOVASI LOKAL — SOLUSI UNTUK MASALAH INDONESIA" warna="#e63329" latarBelakang="#fef2f2">
      ...
      <GridTiga items={[
        { icon: '???', judul: 'Konektivitas Kepulauan', teks: '17.000 pulau dengan akses internet tidak merata. Solusi mesh network dan offline-first app sangat dibutuhkan', warna: '#0891b2', bg: '#ecfeff' },
  ...
  return (
    <PanelBab id="ch158" num="158" judul="TEKNOLOGI & SPIRITUALITAS — HARMONI HIDUP" warna="#22c55e" latarBelakang="#f0fdf4">
      ...
      <GridTiga items={[
        ...
        { icon: '??', judul: 'Etika Islam & AI', teks: 'Bagaimana prinsip Islam (amanah, adil, maslahat) bisa jadi panduan dalam pengembangan teknologi AI', warna: '#e63329', bg: '#fef2f2' },
  ...
  return (
    <PanelBab id="ch159" num="159" judul="KEARIFAN LOKAL — DIGITALISASI BUDAYA" warna="#8b5cf6" latarBelakang="#f5f0ff">
      ...
      <GridTiga items={[
        ...
        { icon: '???', judul: 'Heritage 3D', teks: 'Scan dan model 3D candi, situs bersejarah, dan artefak museum untuk akses virtual global', warna: '#0891b2', bg: '#ecfeff' },
      ]} />
    </PanelBab>
  )
}
