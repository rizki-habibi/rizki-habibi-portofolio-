          ...
          <div className="comic-panel-dark p-4 mt-4">
            ...
            <div className="grid grid-cols-2 gap-2 text-center">
              {[
                ...
                { name: 'Gelar.id', host: 'Coming Soon', color: '#8b5cf6' },
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        ...
        <div>
          ...
          <div className="comic-panel-yellow p-4 text-center">
            ...
            <p className="text-xs text-comic-black/70 mt-2">Mengintegrasikan AI ke platform Gelar.id untuk personalisasi pembelajaran dan QRIS donasi untuk fraud detection.</p>
          </div>
        </div>
      </div>
    </PanelKomik>
