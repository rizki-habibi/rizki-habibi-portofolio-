...
function Ch275to280() {
  const milestone = [
    ...
    { tahun: '2026', event: 'Build komunitas sendiri via Gelar.id', dampak: 'Dari yang belajar dari komunitas, kini membangun komunitas sendiri untuk orang lain', icon: '🚀', warna: '#0891b2' },
  ]
  return (
