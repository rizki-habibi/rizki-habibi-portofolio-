    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
      {panels.map((p, i) => (
        <motion.div key={i}
          ...
          transition={{ delay: i * 0.07 }} viewport={{ once: true, amount: 0.1 }}
  ...
  return (
    <PanelBab id="ch36" chNum="CHAPTER 36" judul="KESEHATAN DIGITAL" warna="#22c55e" latarBelakang="#f0fdf4">
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
          <div className="speech-bubble inline-block text-sm mb-4">?? Teknologi untuk hidup yang lebih sehat!</div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
          ...
          <StoryPanel panels={[
            ...
            { icon: '??', title: 'Waste Management', text: 'Sistem tracking sampah dan jadwal pengambutan berbasis web.', color: '#22c55e' },
        ...
        <div>
          ...
          <div className="space-y-3">
            {[
              ...
              <motion.div key={h.habit} initial={{ opacity: 0, x: -15 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.09 }} viewport={{ once: true }}
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        ...
        <div>
          <div className="comic-panel-dark p-6">
            ...
            {[
              { skill: 'Dekomposisi', desc: 'Memecah masalah besar menjadi bagian kecil yang bisa diselesaikan', icon: '??' },
        ...
        <div>
          ...
          <div className="space-y-3">
            {[
              ...
              { area: 'Content Creation', tools: ['Copywriting', 'Storytelling', 'Visual'], icon: '??', color: '#22c55e' },
              { area: 'Karakter Komik', tools: ['AI Art Tools', 'Character Design'], icon: '??', color: '#f59e0b' },
            ].map((a, i) => (
              <motion.div key={a.area} initial={{ opacity: 0, x: -15 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.09 }} viewport={{ once: true }}
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div>
          ...
          <div className="space-y-4">
            {[
              ...
              <motion.div key={d.dream} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.1 }} viewport={{ once: true }}
        ...
        <div>
          ...
          <GridTiga items={[
            ...
            { icon: '??', title: 'Heart-Driven', text: 'Teknologi yang dibangun dengan hati untuk hati.', color: '#e63329', bg: '#fef2f2' },
          ]} />
        </div>
      </div>
    </PanelBab>
