...
function Ch76() {
  const milestones = [
    { tahun: '2026', target: 'Lulus Skripsi + Launch Gelar.id Beta', status: 'IN PROGRESS', warna: '#1a5cff', icon: '🎓' },
    { tahun: '2027', target: 'Gelar.id 1000+ Pengguna Aktif', status: 'TARGET', warna: '#22c55e', icon: '🚀' },
    { tahun: '2027', target: 'Bangun tim kecil 5-10 orang', status: 'TARGET', warna: '#8b5cf6', icon: '👥' },
    { tahun: '2028', target: 'Gelar.id resmi sebagai startup', status: 'VISION', warna: '#f59e0b', icon: '🏢' },
    { tahun: '2028', target: 'Publish jurnal/penelitian AI & Web', status: 'VISION', warna: '#e63329', icon: '📄' },
    { tahun: '2030', target: 'Gelar.id jangkau 10 kota di Indonesia', status: 'DREAM', warna: '#0891b2', icon: '🌏' },
  ]
  return (
...
function Ch79() {
  const tren = [
    ...
    { nama: 'AR/VR Web', deskripsi: 'WebXR dan spatial computing — internet yang bisa kamu masuki secara fisik. Gelar.id mungkin di sini?', status: 'MASA DEPAN', warna: '#e63329', icon: '🥽' },
  ]
  return (
