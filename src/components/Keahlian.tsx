          ...
          {daftarKeahlian.map((keahlian, i) => (
            ...
            >
              <div
                ...
                style={{ background: warnaLabel[keahlian.label] || '#0a0a0a', color: keahlian.label === 'MASTER' ? '#0a0a0a' : 'white' }}
              >
                {keahlian.label}
              </div>
              <keahlian.icon
                className="w-8 h-8 md:w-10 md:h-10"
                style={{ color: keahlian.color === '#000000' ? '#0a0a0a' : keahlian.color }}
              />
              ...
              <span className="font-comic text-[10px] text-comic-black/60">{keahlian.level}%</span>
            </motion.div>
          ))}
        </div>
            ...
            {keahlianLunak.map((keahlian, i) => (
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  <span className="text-2xl">{keahlian.emoji}</span>
                  <div>
                    <div className="font-bold text-white text-sm">{keahlian.name}</div>
                    <div className="text-white/50 text-xs">{keahlian.desc}</div>
                  </div>
                  <div className="ml-auto font-comic text-comic-yellow text-lg">{keahlian.level}</div>
                </div>
