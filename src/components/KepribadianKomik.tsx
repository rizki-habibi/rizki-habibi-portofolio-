...
const kemampuanUnik = [
  ...
  {
    icon: '🛡️',
    judul: 'Gelut di Situasi Tertentu',
    desc: 'Dalam kondisi krisis, deadline, atau tekanan tinggi, justru muncul fokus ekstra. Bukan orang yang menyerah duluan — tapi orang yang cari jalan keluar sambil tetap tenang.',
    warna: '#e63329',
    bg: '#fef2f2',
    tag: 'RESILIENSI',
  },
