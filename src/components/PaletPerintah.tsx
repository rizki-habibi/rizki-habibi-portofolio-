...
const daftarChapter: Perintah[] = [
  ...
  { id: 'ch160', label: 'Ch.160 Sejarah Computing', desc: 'Turing 1936 sampai GPT hingga KVT.kom 2026', icon: FiBook, action: '#ch160', type: 'navigate', kategori: 'chapter', tag: ['sejarah', 'computing', 'turing'] },
  { id: 'ch163', label: 'Ch.163 Satu Tahun KVT.kom', desc: 'Target: 5000 user, 20 kursus, 200 alumni dapat kerja', icon: FiTrendingUp, action: '#ch163', type: 'navigate', kategori: 'chapter', tag: ['kvtkom', '1 tahun', 'target'] },
  ...
  { id: 'ch160', label: 'Ch.160 Sejarah Computing', desc: 'Turing 1936, ARPANET, WWW, Laravel, GPT hingga KVT.kom', icon: FiBook, action: '#ch160', type: 'navigate', kategori: 'chapter', tag: ['sejarah', 'computing', 'turing'] },
  { id: 'ch163', label: 'Ch.163 Satu Tahun KVT.kom', desc: 'Target: 5000 user, 20 kursus, 200 alumni dapat kerja', icon: FiTrendingUp, action: '#ch163', type: 'navigate', kategori: 'chapter', tag: ['kvtkom', '1 tahun', 'target'] },
