...
const daftarProyek = [
  {
    ...
    bgColor: '#e8f0ff',
    kategori: 'Web',
    problem: 'Pengelolaan data KVT dan sertifikasi gelar masih manual dan tidak terintegrasi.',
    solution: 'Membangun ekosistem digital dengan Laravel + Next.js yang menyatukan semua data dalam satu platform.',
    result: 'Platform aktif dalam pengembangan, mengelola data akademik dan sertifikasi secara terpusat.',
  },
  {
    id: 2,
    num: '02',
    ...
    github: '#',
    demo: 'https://simpeg.sman2jember.sch.id',
    year: '2025',
    color: '#22c55e',
    bgColor: '#f0fdf4',
    kategori: 'Web',
    badge: '🔧 DALAM PERBAIKAN',
    problem: 'SMAN 2 Jember membutuhkan sistem digital untuk manajemen data kepegawaian yang sebelumnya manual.',
    solution: 'Membangun SIMPEG berbasis Laravel dengan fitur manajemen pegawai, absensi, dan laporan administrasi.',
    result: 'Sistem sudah live di simpeg.sman2jember.sch.id dan sedang dalam tahap perbaikan dan pengembangan lanjutan.',
  },
  {
    id: 3,
    num: '03',
